...
<script>
      ...
      methods: {
        loadContacts: function() {
          this.$http.get('http://localhost:8080/magnoliaAuthor/.rest/nodes/v1/contacts/?depth=5&excludeNodeTypes=rep%3Asystem%2Crep%3AAccessControl&includeMetadata=false').then(response => {
            // success callback
